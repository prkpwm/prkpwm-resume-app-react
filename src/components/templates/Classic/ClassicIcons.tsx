...
export function Ico({ children }: Readonly<{ children: React.ReactNode }>) {
  return <span className="c-ico">{children}</span>;
}

export function SectionTitle({ icon, label }: Readonly<{ icon: React.ReactNode; label: string }>) {
  return <div className="c-section-title"><span className="c-section-title-icon">{icon}</span><span>{label}</span></div>;
}

export function SidebarSectionTitle({ icon, label }: Readonly<{ icon: React.ReactNode; label: string }>) {
